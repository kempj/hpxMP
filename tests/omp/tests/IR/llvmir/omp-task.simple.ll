; ModuleID = 'src/omp-task.simple.c'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.anon = type { i32*, i32* }

@.str = private unnamed_addr constant [12 x i8] c"x par = %d\0A\00", align 1
@.str1 = private unnamed_addr constant [12 x i8] c"i par = %d\0A\00", align 1
...
@.str2 = private unnamed_addr constant [14 x i8] c"final x = %d\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0), i32 %5)
  ret i32 0
}
...
entry:
  ...
  %3 = bitcast { i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64. to i8*
  %4 = bitcast { i32, i32, i32, i32, i8* }* @.omp.default.loc.64. to i8*
  ...
  %5 = getelementptr inbounds %struct.anon* %"(anon)arg3", i32 0, i32 0
  %ref = load i32** %5, align 8
  %6 = getelementptr inbounds %struct.anon* %"(anon)arg3", i32 0, i32 1
  %ref3 = load i32** %6, align 8
  %7 = load i32* %ref, align 4
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %7)
  %8 = load i32* %ref3, align 4
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %8)
  %.gtid. = load i32* %.__kmpc_global_thread_num.
  %9 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64., i32 %.gtid.)
  %10 = icmp ne i32 %9, 0
  br i1 %10, label %omp.cancel_barrier.exit, label %omp.cancel_barrier.continue
