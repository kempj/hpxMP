; ModuleID = 'omp-single-copyprivate-1var.c'
...
omp.single.then:                                  ; preds = %for.body
  ...
  call void @__kmpc_end_single({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.5)
  br label %omp.single.end

omp.single.end:                                   ; preds = %omp.single.then, %for.body
  %17 = getelementptr { i32* }* %cpy.var, i32 0, i32 0
  %.gtid.6 = load i32* %.__kmpc_global_thread_num.
  %18 = call i8* @__kmpc_threadprivate_cached({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.6, i8* bitcast (i32* @j to i8*), i64 4, i8*** @j.cache.)
  %19 = bitcast i8* %18 to i32*
  store i32* %19, i32** %17
  %.gtid.7 = load i32* %.__kmpc_global_thread_num.
  %20 = load i32* %.did_it., align 4
  %"(void*)cpyrec" = bitcast { i32* }* %cpy.var to i8*
  call void @__kmpc_copyprivate({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.7, i64 8, i8* %"(void*)cpyrec", void (i8*, i8*)* @.omp_copy_func., i32 %20)
  %.gtid.8 = load i32* %.__kmpc_global_thread_num.
  call void @__kmpc_critical({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.8, [8 x i32]* @.gomp_critical_user_.var)
  %21 = load i32* %ref3, align 4
  %.gtid.9 = load i32* %.__kmpc_global_thread_num.
  %22 = call i8* @__kmpc_threadprivate_cached({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.9, i8* bitcast (i32* @j to i8*), i64 4, i8*** @j.cache.)
  ...
  call void @__kmpc_end_critical({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.8, [8 x i32]* @.gomp_critical_user_.var)
  %.gtid.10 = load i32* %.__kmpc_global_thread_num.
  %26 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.32., i32 %.gtid.10)
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %omp.cancel_barrier.exit, label %omp.cancel_barrier.continue

omp.cancel_barrier.exit:                          ; preds = %omp.single.end
  br label %omp.cancel_barrier.continue14
...
for.end:                                          ; preds = %for.cond
  ...
  %29 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64., i32 %.gtid.12)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %omp.cancel_barrier.exit13, label %omp.cancel_barrier.continue14

omp.cancel_barrier.exit13:                        ; preds = %for.end
  br label %omp.cancel_barrier.continue14

omp.cancel_barrier.continue14:                    ; preds = %omp.cancel_barrier.exit, %omp.cancel_barrier.exit13, %for.end
  ret void
}
...
entry:
  ...
  %cpy.dst = bitcast i8* %0 to { i32* }*
  %cpy.src = bitcast i8* %1 to { i32* }*
  %2 = getelementptr { i32* }* %cpy.dst, i32 0, i32 0
  %3 = getelementptr { i32* }* %cpy.src, i32 0, i32 0
