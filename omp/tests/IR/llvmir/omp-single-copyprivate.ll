...
omp.single.end:                                   ; preds = %omp.single.then, %for.body
  %22 = getelementptr { i32* }* %cpy.var, i32 0, i32 0
  ...
  %25 = load i32* %.did_it., align 4
  %"(void*)cpyrec" = bitcast { i32* }* %cpy.var to i8*
  call void @__kmpc_copyprivate({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.9, i64 8, i8* %"(void*)cpyrec", void (i8*, i8*)* @.omp_copy_func., i32 %25)
  %.gtid.10 = load i32* %.__kmpc_global_thread_num.
  call void @__kmpc_critical({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.10, [8 x i32]* @.gomp_critical_user_.var)
  %26 = load i32* %ref3, align 4
  %.gtid.11 = load i32* %.__kmpc_global_thread_num.
  %27 = call i8* @__kmpc_threadprivate_cached({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.11, i8* bitcast (i32* @j to i8*), i64 4, i8*** @j.cache.)
  ...
  call void @__kmpc_end_critical({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.10, [8 x i32]* @.gomp_critical_user_.var)
  %.gtid.12 = load i32* %.__kmpc_global_thread_num.
  %31 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.32., i32 %.gtid.12)
  %32 = icmp ne i32 %31, 0
  br i1 %32, label %omp.cancel_barrier.exit, label %omp.cancel_barrier.continue
...
for.end:                                          ; preds = %for.cond
  ...
  %34 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64., i32 %.gtid.14)
  %35 = icmp ne i32 %34, 0
  br i1 %35, label %omp.cancel_barrier.exit15, label %omp.cancel_barrier.continue16

omp.cancel_barrier.exit15:                        ; preds = %for.end
  br label %omp.cancel_barrier.continue16

omp.cancel_barrier.continue16:                    ; preds = %omp.cancel_barrier.exit, %omp.cancel_barrier.exit15, %for.end
  ret void
}
