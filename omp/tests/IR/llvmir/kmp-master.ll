...
@0 = private unnamed_addr constant [36 x i8] c";omp-master.c;.omp_microtask.;6;9;;\00"
@.str = private unnamed_addr constant [29 x i8] c"this should be thread 0: %d\0A\00", align 1
@1 = private unnamed_addr constant [36 x i8] c";omp-master.c;.omp_microtask.;6;9;;\00"
@.str1 = private unnamed_addr constant [17 x i8] c"all threads: %d\0A\00", align 1
...
@2 = private unnamed_addr constant [37 x i8] c";omp-master.c;.omp_microtask.;4;21;;\00"
@3 = private unnamed_addr constant [25 x i8] c";omp-master.c;main;4;9;;\00"
...
entry:
  ...
  store i8* getelementptr inbounds ([25 x i8]* @3, i32 0, i32 0), i8** %2
...
entry:
  ...
  store i8* getelementptr inbounds ([36 x i8]* @0, i32 0, i32 0), i8** %7
  %.gtid. = load i32* %.__kmpc_global_thread_num.
  %8 = call i32 @__kmpc_master({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.)
  %tobool = icmp ne i32 %8, 0
  br i1 %tobool, label %omp.master.then, label %omp.master.end

omp.master.then:                                  ; preds = %entry
  %call = call i32 (...)* @omp_get_thread_num(), !dbg !22
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([29 x i8]* @.str, i32 0, i32 0), i32 %call), !dbg !24
  %9 = getelementptr inbounds { i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 0, i32 4, !dbg !24
  store i8* getelementptr inbounds ([36 x i8]* @1, i32 0, i32 0), i8** %9, !dbg !24
  %.gtid.4 = load i32* %.__kmpc_global_thread_num., !dbg !24
  call void @__kmpc_end_master({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.2., i32 %.gtid.4), !dbg !24
  br label %omp.master.end, !dbg !24

omp.master.end:                                   ; preds = %omp.master.then, %entry
  %call5 = call i32 (...)* @omp_get_thread_num(), !dbg !25
  %call6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str1, i32 0, i32 0), i32 %call5), !dbg !26
  %10 = getelementptr inbounds { i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64., i32 0, i32 4
  store i8* getelementptr inbounds ([37 x i8]* @2, i32 0, i32 0), i8** %10
  %.gtid.7 = load i32* %.__kmpc_global_thread_num.
  %11 = call i32 @__kmpc_cancel_barrier({ i32, i32, i32, i32, i8* }* %.__kmpc_ident_t.64., i32 %.gtid.7)
  %12 = icmp ne i32 %11, 0
  br i1 %12, label %omp.cancel_barrier.exit, label %omp.cancel_barrier.continue

omp.cancel_barrier.exit:                          ; preds = %omp.master.end
  br label %omp.cancel_barrier.continue

omp.cancel_barrier.continue:                      ; preds = %omp.cancel_barrier.exit, %omp.master.end
  ret void, !dbg !27
}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/jeremy/code/research/hpxMP/omp-tests/omp-master.c]
...
!22 = metadata !{i32 7, i32 49, metadata !23, null}
!23 = metadata !{i32 786443, metadata !1, metadata !9, i32 5, i32 5, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/jeremy/code/research/hpxMP/omp-tests/omp-master.c]
!24 = metadata !{i32 7, i32 9, metadata !23, null}
!25 = metadata !{i32 8, i32 37, metadata !23, null} ; [ DW_TAG_imported_declaration ]
!26 = metadata !{i32 8, i32 9, metadata !23, null} ; [ DW_TAG_imported_declaration ]
!27 = metadata !{i32 9, i32 5, metadata !9, null}
