...
3. Example batch scripts for running the benchmark suite on the HECToR Cray
   XE6 machine are provided; hectorxe6.pbs is a script for use with the PGI 
   and Cray compilers and hectorxe6_gcc.pbs is a script for use with the Gnu 
   compiler. 
