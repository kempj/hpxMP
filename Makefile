...
libiomp5.so: intel_rt.o hpx_runtime.o loop_schedule.o kmp_atomic.o
	$(CC) -shared -Wl,-x -Wl,-soname=libiomp5.so,--version-script=exports_so.txt -o libiomp5.so intel_rt.o loop_schedule.o kmp_atomic.o hpx_runtime.o -L. `pkg-config --cflags --libs $(HPX_BUILD_TYPE)`
